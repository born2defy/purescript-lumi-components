...
import React.Basic.Hooks (JSX, ReactComponent, reactComponent, element, useState, (/\))
...
docs =
  flip element {}
    $ unsafePerformEffect do
        reactComponent "QRCodeExample" \_ -> React.do
...
qrcodeExample =
  unsafePerformEffect do
    reactComponent "QRCode" \props -> React.do
